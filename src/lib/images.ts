...
export const LOCAL_IMAGES = {
  hero: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&fm=webp&q=60&w=720',
  bed: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&fm=webp&q=60&w=420',
  sofa: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&fm=webp&q=60&w=420',
  dining: 'https://images.unsplash.com/photo-1617806118233-18e1de247200?auto=format&fit=crop&fm=webp&q=60&w=420',
  wardrobe: 'https://images.unsplash.com/photo-1558997519-83ea9252def8?auto=format&fit=crop&fm=webp&q=60&w=420',
  chair: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&fm=webp&q=60&w=420',
} as const;
 ...
 */
export function compressCloudinaryUrl(url: string, width = 450): string {
  ...
  return url.replace(
    /\/image\/upload\/(v\d+\/)?/,
    `/image/upload/f_auto,q_auto:eco,c_limit,w_${width},dpr_auto/$1`
  ).replace(
    /\/video\/upload\/(v\d+\/)?/,
 ...
 */
export function optimizeUnsplashUrl(url: string, width = 450): string {
