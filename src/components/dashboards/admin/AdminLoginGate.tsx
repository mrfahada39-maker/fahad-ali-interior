    ...
    <div className="min-h-screen bg-[#FAF7F2] text-[#221814] flex flex-col items-center justify-center p-4 sm:p-6 select-none relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-3xl border-2 border-[#D4AF37]/50 p-6 sm:p-8 shadow-[0_20px_50px_rgba(44,30,24,0.08)] space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="mrfahada39@gmail.com"
                required
        ...
        <div className="relative flex items-center justify-center my-2">
          ...
          <span className="bg-white px-3 text-xs font-serif text-[#A68254] uppercase tracking-wider">or</span>
          <div className="border-t border-[#EAE0D5] w-full" />
        </div>
        ...
        <button
          ...
          className="w-full h-12 bg-white hover:bg-[#FAF6F0] border border-[#D4AF37]/50 text-[#221814] font-serif font-bold text-xs tracking-wider uppercase rounded-xl transition-all shadow-xs flex items-center justify-center gap-3 cursor-pointer"
        >
