...
async function main() {
  ...
  const categories = [
    ...
    { name: 'Storage', icon: 'Archive', items: '22 Items', image: 'https://res.cloudinary.com/dfd8rzojj/image/upload/v1785011112/fahad-ali-interior/categories/on6j6aaprejwskrykplu.jpg', description: 'Smart storage solutions', order: 8 },
